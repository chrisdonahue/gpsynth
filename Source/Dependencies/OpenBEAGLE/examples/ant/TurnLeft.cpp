...
/*!
 *  \file   TurnLeft.cpp
 *  \brief  Implementation of class TurnLeft.
...
/*!
 *  \brief Construct a turn left primitive.
 */
TurnLeft::TurnLeft() :
		GP::Primitive(0,"L")
{ }
...
/*!
 *  \brief Execute turn left primitive.
 *  \param outDatum GP datum, in the actual case a reference to the ant simulator.
 *  \param ioContext Evolutionary context.
 */
void TurnLeft::execute(GP::Datum& outDatum, GP::Context& ioContext)
{
