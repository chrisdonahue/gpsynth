...
void GP::InitHalfConstrainedOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::InitHalfConstrainedOp::registerParams(Beagle::System&)");
}
        ...
        GP::Context &ioContext) const
{
	...
	Beagle_StackTraceEndM("unsigned int GP::InitHalfConstrainedOp::initTree(GP::Tree &outTree, unsigned int inMinDepth, unsigned int inMaxDepth, GP::Context &ioContext) const");
}
