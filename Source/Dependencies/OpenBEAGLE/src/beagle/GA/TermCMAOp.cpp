...
void GA::TermCMAOp::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::TermCMAOp::registerParams(System&)");
}
...
bool GA::TermCMAOp::terminate(const Deme& ioDeme, Context& ioContext)
{
	...
	Beagle_LogTraceM(
	    ioContext.getSystem().getLogger(),
	    "termination", "Beagle::TermCMAOp",
	    "None of the CMA-ES termination criteria reached"
	);
	return false;
	Beagle_StackTraceEndM("bool GA::TermCMAOp::terminate(const Deme& ioDeme, Context& ioContext)");
}
