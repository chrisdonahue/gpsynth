...
public:
	...
	inline void copy(const Member& inOriginal, System& ioSystem)
	{
		...
		Beagle_StackTraceEndM("ProcessingBuffer::copy(const Member& inOriginal, System& ioSystem)");
	}
	...
	inline const std::string& getName() const
	{
		...
		return lName;
		Beagle_StackTraceEndM("const std::string& ProcessingBuffer::getName() const");
	}
	...
	inline const std::string& getType() const
	{
		...
		return lType;
		Beagle_StackTraceEndM("const std::string& ProcessingBuffer::getType() const");
	}
