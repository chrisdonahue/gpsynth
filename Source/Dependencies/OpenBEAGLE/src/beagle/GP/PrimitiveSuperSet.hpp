...
public:
	...
	inline const PrimitiveSet::Handle& operator[](unsigned int inIndex) const
	{
		...
		Beagle_StackTraceEndM("const PrimitiveSet::Handle& GP::PrimitiveSuperSet::operator[](unsigned int inIndex) const");
	}
	...
	inline PrimitiveSet::Handle& operator[](unsigned int inIndex)
	{
		Beagle_StackTraceBeginM();
		return mPrimitSets[inIndex];
		Beagle_StackTraceEndM("PrimitiveSet::Handle& GP::PrimitiveSuperSet::operator[](unsigned int inIndex)");
	}
	...
	inline void addPrimitive(GP::Primitive::Handle inPrimitive, bool inReplace=false)
	{
		...
		Beagle_StackTraceEndM("void GP::PrimitiveSuperSet::addPrimitive(GP::Primitive::Handle inPrimitive)");
	}
	...
	inline GP::Primitive::Handle getPrimitiveByName(std::string inName) const
	{
		...
		return lPrimitive;
		Beagle_StackTraceEndM("GP::Primitive::Handle GP::PrimitiveSuperSet::getPrimitiveByName(std::string inName) const");
	}
	...
	inline const GP::PrimitiveMap& getPrimitiveMap() const
	{
		Beagle_StackTraceBeginM();
		return mPrimitMap;
		Beagle_StackTraceEndM("const GP::PrimitiveMap& GP::PrimitiveSuperSet::getPrimitiveMap() const");
	}
	...
	inline GP::PrimitiveMap& getPrimitiveMap()
	{
		Beagle_StackTraceBeginM();
		return mPrimitMap;
		Beagle_StackTraceEndM("GP::PrimitiveMap& GP::PrimitiveSuperSet::getPrimitiveMap()");
	}
	...
	inline const PrimitiveSet::Bag& getPrimitSetBag() const
	{
		Beagle_StackTraceBeginM();
		return mPrimitSets;
		Beagle_StackTraceEndM("const PrimitiveSet::Bag& GP::PrimitiveSuperSet::getPrimitSetBag() const");
	}
	...
	inline PrimitiveSet::Bag& getPrimitSetBag()
	{
		Beagle_StackTraceBeginM();
		return mPrimitSets;
		Beagle_StackTraceEndM("PrimitiveSet::Bag& GP::PrimitiveSuperSet::getPrimitSetBag()");
	}
	...
	inline unsigned int size() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GP::PrimitiveSuperSet::size() const");
	}
	...
	inline bool empty() const
	{
		...
		Beagle_StackTraceEndM("bool GP::PrimitiveSuperSet::empty() const");
	}
