...
public:
	...
	unsigned int getIntVectorSize() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GA::InitIntVecOp::getIntVectorSize() const");
	}
	...
	void getIntVectorSize(unsigned int inIntVectorSize)
	{
		...
		Beagle_StackTraceEndM("void GA::InitIntVecOp::getIntVectorSize(unsigned int inIntVectorSize)");
	}
