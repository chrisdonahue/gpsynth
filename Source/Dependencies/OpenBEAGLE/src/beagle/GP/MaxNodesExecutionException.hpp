...
public:
	...
	inline unsigned int getNodesExecuted() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GP::MaxNodesExecutionException::getNodesExecuted() const");
	}
	...
	inline unsigned int getMaxNodesAllowed() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GP::MaxNodesExecutionException::getMaxNodesAllowed() const");
	}
