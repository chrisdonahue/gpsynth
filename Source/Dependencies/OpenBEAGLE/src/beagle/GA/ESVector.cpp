...
bool GA::ESPair::operator==(const GA::ESPair& inRightPair) const
{
	...
	Beagle_StackTraceEndM("bool GA::ESPair::operator==(const GA::ESPair&) const");
}
...
void GA::ESVector::copy(const Member& inOriginal, System& ioSystem)
{
	...
	(*this) = lOriginal;
	Beagle_StackTraceEndM("void GA::ESVector::copy(const Member&,System&)");
}
...
bool GA::ESVector::isEqual(const Object& inRightObj) const
{
	...
	Beagle_StackTraceEndM("bool GA::ESVector::isEqual(const Object&) const");
}
