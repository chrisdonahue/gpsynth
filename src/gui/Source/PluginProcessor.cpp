...
//==============================================================================
const String GeneticProgrammingSynthesizerAudioProcessor::getName() const
{
...
const String GeneticProgrammingSynthesizerAudioProcessor::getInputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}

const String GeneticProgrammingSynthesizerAudioProcessor::getOutputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}
...
int GeneticProgrammingSynthesizerAudioProcessor::getNumPrograms()
{
    return 0;
}

int GeneticProgrammingSynthesizerAudioProcessor::getCurrentProgram()
{
    return 0;
}

void GeneticProgrammingSynthesizerAudioProcessor::setCurrentProgram (int index)
{
}

const String GeneticProgrammingSynthesizerAudioProcessor::getProgramName (int index)
{
    return String::empty;
}

void GeneticProgrammingSynthesizerAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
//==============================================================================
bool GeneticProgrammingSynthesizerAudioProcessor::hasEditor() const
{
