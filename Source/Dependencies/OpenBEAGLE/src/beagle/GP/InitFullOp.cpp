        ...
        GP::Context& ioContext) const
{
	...
	return lSubTreeSize;
	Beagle_StackTraceEndM("unsigned int GP::InitFullOp::initSubTreeFull(GP::Tree& ioTree, unsigned int inSubTreeDepth, GP::Context& ioContext) const");
}
                                      ...
                                      GP::Context &ioContext) const
{
	...
	Beagle_StackTraceEndM("unsigned int GP::InitFullOp::initTree(GP::Tree& outTree, unsigned int inMinDepth, unsigned int inMaxDepth, GP::Context &ioContext) const");
}
