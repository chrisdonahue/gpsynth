 ...
 */
const std::type_info* GP::And::getArgType(unsigned int inN, GP::Context&) const
{
	Beagle_StackTraceBeginM();
	Beagle_AssertM(inN<2);
	return &typeid(Bool);
	Beagle_StackTraceEndM("const std::type_info* GP::And::getArgType(unsigned int inN, GP::Context&) const");
}
 ...
 */
const std::type_info* GP::And::getReturnType(GP::Context&) const
{
	Beagle_StackTraceBeginM();
	return &typeid(Bool);
	Beagle_StackTraceEndM("const std::type_info* GP::And::getReturnType(GP::Context&) const");
}
