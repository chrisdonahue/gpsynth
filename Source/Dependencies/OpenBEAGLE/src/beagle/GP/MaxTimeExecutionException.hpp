...
public:
	...
	inline double getTimeElapsed() const
	{
		...
		return mTimeElapsed;
		Beagle_StackTraceEndM("double GP::MaxTimeExecutionException::getTimeElapsed() const");
	}
	...
	inline double getMaxTimeAllowed() const
	{
		...
		Beagle_StackTraceEndM("double GP::MaxTimeExecutionException::getMaxTimeAllowed() const");
	}
