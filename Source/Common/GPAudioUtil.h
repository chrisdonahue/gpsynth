...
namespace GPAudioUtil {
	...
	// COMPARISON
	extern double compareAmplitudes(unsigned numSamples, float* samplesOne, float* samplesTwo);
    extern double compareAmplitudesWeighted(unsigned numSamples, float* samplesOne, float* samplesTwo, float weight);
