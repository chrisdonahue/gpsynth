 ...
 */
TSPEvalOp::TSPEvalOp() :
		Beagle::HPC::EvaluationOp("TSPEvalOp")
{ }
...
Fitness::Handle TSPEvalOp::evaluate(Individual& inIndividual, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("Fitness::Handle TSPEvalOp::evaluate(Individual&, Context&)");
}
...
{
	Beagle_StackTraceBeginM();
	Beagle::HPC::EvaluationOp::init(ioSystem);
	...
	Beagle_StackTraceEndM("void TSPEvalOp::init(Beagle::System&)");
}
