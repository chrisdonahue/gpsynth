...
public:
	...
	unsigned int getIntVectorSize() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GA::InitIndicesIntVecOp::getIntVectorSize() const");
	}
	...
	void setIntVectorSize(unsigned int inIntVectorSize)
	{
		...
		Beagle_StackTraceEndM("void GA::InitIndicesIntVecOp::getIntVectorSize(unsigned int inIntVectorSize)");
	}
