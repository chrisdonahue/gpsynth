...
void GA::FloatVector::copy(const Member& inOriginal, System& ioSystem)
{
	...
	(*this) = lOriginal;
	Beagle_StackTraceEndM("void GA::FloatVector::copy(const Member&,System&)");
}
...
bool GA::FloatVector::isEqual(const Object& inRightObj) const
{
	...
	return (lLeft == lRight);
	Beagle_StackTraceEndM("bool GA::FloatVector::isEqual(const Object&) const");
}
...
bool GA::FloatVector::isLess(const Object& inRightObj) const
{
	...
	const std::vector<double>& lRight = lRightVector;
	return (lLeft < lRight);
	Beagle_StackTraceEndM("bool GA::FloatVector::isLess(const Object&) const");
}
...
void GA::FloatVector::readWithContext(PACC::XML::ConstIterator inIter, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GA::FloatVector::readWithContext(PACC::XML::ConstIterator,Context&)");
}
...
void GA::FloatVector::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void GA::FloatVector::write(PACC::XML::Streamer&,bool) const");
}
