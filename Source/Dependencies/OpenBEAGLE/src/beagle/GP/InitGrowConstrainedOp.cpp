        ...
        GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("unsigned int GP::InitGrowConstrainedOp::initConstrainedSubTreeGrow(GP::Tree& ioTree, unsigned int inMinDepth, unsigned int inMaxDepth, GP::Context& ioContext) const");
}
...
void GP::InitGrowConstrainedOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::InitGrowConstrainedOp::registerParams(Beagle::System&)");
}
        ...
        GP::Context& ioContext) const
{
	...
	return lSubTreeSize;
	Beagle_StackTraceEndM("unsigned int GP::InitGrowConstrainedOp::initTree(GP::Tree& outTree, unsigned int inMinDepth, unsigned int inMaxDepth, GP::Context& ioContext) const");
}
