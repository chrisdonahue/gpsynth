...
./build/GeneticProgrammingSynthesizer --target ./build/AMExample.wav --fft 16 --exp 0 --threshold 0 --fitnesstype 1 --numgenerations 1 --values 220 1 --popsize 50 --mid 4 --md 6 --ctype 0 --rselect 0 --cselect 0 --crosspercent 0.9 --mutatechance 0.0
