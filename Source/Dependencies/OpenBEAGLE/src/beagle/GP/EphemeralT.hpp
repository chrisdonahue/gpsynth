...
const std::type_info* Beagle::GP::EphemeralT<T>::getReturnType(Beagle::GP::Context& ioContext) const
{
	...
	return &typeid(T);
	Beagle_StackTraceEndM("const std::type_info* GP::EphemeralT<T>::getReturnType(GP::Context& ioContext) const");
}
...
void Beagle::GP::EphemeralT<T>::getValue(Beagle::Object& outValue)
{
	...
	lValueT = *mValue;
	Beagle_StackTraceEndM("void GP::EphemeralT<T>::getValue(Object& outValue)");
}
...
Beagle::GP::EphemeralT<T>::giveReference(unsigned int inNumberArguments, Beagle::GP::Context& ioContext)
{
	...
	return this;
	Beagle_StackTraceEndM("GP::Primitive::Handle GP::EphemeralT<T>::giveReference(unsigned int inNumberArguments, GP::Context& ioContext)");
}
...
void Beagle::GP::EphemeralT<T>::execute(Beagle::GP::Datum& outDatum, Beagle::GP::Context& ioContext)
{
	...
	lResult = *mValue;
	Beagle_StackTraceEndM("void GP::EphemeralT<T>::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
...
bool Beagle::GP::EphemeralT<T>::haveValue() const
{
	Beagle_StackTraceBeginM();
	return true;
	Beagle_StackTraceEndM("bool GP::EphemeralT<T>::haveValue() const");
}
...
void Beagle::GP::EphemeralT<T>::readWithContext(PACC::XML::ConstIterator inIter, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::EphemeralT<T>::readWithContext(PACC::XML::ConstIterator inIter, GP::Context& ioContext)");
}
...
void Beagle::GP::EphemeralT<T>::setValue(const Beagle::Object& inValue)
{
	...
	*mValue = lValueT;
	Beagle_StackTraceEndM("void GP::EphemeralT<T>::setValue(const Object& inValue)");
}
...
void Beagle::GP::EphemeralT<T>::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void GP::EphemeralT<T>::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const");
}
