...
{
    extern const char*   ProductInfo_txt;
    const int            ProductInfo_txtSize = 131;

    extern const char*   ProductWebsite_html;
    const int            ProductWebsite_htmlSize = 219;

    extern const char*   SedCommand_txt;
    const int            SedCommand_txtSize = 61;
