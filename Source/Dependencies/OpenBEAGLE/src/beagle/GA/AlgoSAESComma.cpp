...
/*!
 *  \file   beagle/GA/src/AlgoSAESComma.cpp
 *  \brief  Source code of class GA::AlgoSAESComma.
...
/*!
 *  \brief Construct (\mu,\lambda) self-adaptive evolution strategy algorithm.
 */
GA::AlgoSAESComma::AlgoSAESComma(void) :
		Algorithm("GA-AlgoSAESComma")
{ }


/*!
 *  \brief Configure evolver with (\mu,\lambda) self-adaptive evolution strategy algorithm.
 *  \param ioEvolver Evolver modified by setting the algorithm.
 *  \param ioSystem Evolutionary system.
 *
 */
void GA::AlgoSAESComma::configure(Evolver& ioEvolver, System& ioSystem)
{
	...
	std::string lMCLOpName = "MuCommaLambdaOp";
	...
	Beagle_StackTraceEndM("void AlgoSAESComma::configure(Evolver&,System&)");
}
