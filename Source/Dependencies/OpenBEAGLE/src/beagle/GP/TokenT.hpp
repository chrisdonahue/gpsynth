...
public:
	...
	inline const T& getToken() const
	{
		...
		return mToken;
		Beagle_StackTraceEndM("const T& GP::TokenT<T>::getToken() const");
	}
	...
	inline T& getToken()
	{
		Beagle_StackTraceBeginM();
		return mToken;
		Beagle_StackTraceEndM("T& GP::TokenT<T>::getToken()");
	}
	...
	inline void setToken(const T& inToken)
	{
		Beagle_StackTraceBeginM();
		mToken = inToken;
		Beagle_StackTraceEndM("void GP::TokenT<T>::setToken(const T& inToken)");
	}
...
const std::type_info* Beagle::GP::TokenT<T>::getReturnType(Beagle::GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(T);
	Beagle_StackTraceEndM("const std::type_info* GP::TokenT<T>::getReturnType(GP::Context& ioContext) const");
}
...
void Beagle::GP::TokenT<T>::getValue(Beagle::Object& outValue)
{
	...
	lValueT = mToken;
	Beagle_StackTraceEndM("void GP::TokenT<T>::getValue(Object& outValue)");
}
...
void Beagle::GP::TokenT<T>::execute(Beagle::GP::Datum& outResult, Beagle::GP::Context& ioContext)
{
	...
	lResult = mToken;
	Beagle_StackTraceEndM("void GP::TokenT<T>::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
...
bool Beagle::GP::TokenT<T>::haveValue() const
{
	Beagle_StackTraceBeginM();
	return true;
	Beagle_StackTraceEndM("bool GP::TokenT<T>::haveValue() const");
}
...
void Beagle::GP::TokenT<T>::setValue(const Beagle::Object& inValue)
{
	...
	mToken = lValueT;
	Beagle_StackTraceEndM("void GP::TokenT<T>::setValue(const Object& inValue)");
}
