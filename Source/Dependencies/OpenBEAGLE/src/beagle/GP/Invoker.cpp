                                       ...
                                       GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("double GP::Invoker::getSelectionWeight(unsigned int inNumberArguments, GP::Context& ioContext) const");
}
...
bool GP::Invoker::isSelectionWeightStable(unsigned int inNumberArguments) const
{
	...
	Beagle_StackTraceEndM("bool GP::Invoker::isSelectionWeightStable(unsigned int inNumberArguments) const");
}
...
bool GP::Invoker::validate(GP::Context& ioContext) const
{
	...
	return false;
	Beagle_StackTraceEndM("bool GP::Invoker::validate(GP::Context& ioContext) const");
}
