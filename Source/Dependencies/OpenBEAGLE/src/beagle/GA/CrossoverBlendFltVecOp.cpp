...
void Beagle::GA::CrossoverBlendFltVecOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::CrossoverBlendFltVecOp::registerParams(System& ioSystem)");
}
        ...
        Beagle::Context&    ioContext2)
{
	...
	Beagle_LogDebugM(
	    ...
	    "Individuals mated (before real-valued GA blend crossover)"
	);
	...
	Beagle_LogDebugM(
	    ioContext1.getSystem().getLogger(),
	    "crossover",
	    "Beagle::GA::CrossoverBlendFltVec",
	    "Individuals mated (after real-valued GA blend crossover)"
	);
	Beagle_LogObjectDebugM(
	    ioContext1.getSystem().getLogger(),
	    "crossover",
