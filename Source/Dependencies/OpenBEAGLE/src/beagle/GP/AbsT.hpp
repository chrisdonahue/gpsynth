        ...
        Beagle::GP::Context& ioContext) const
{
	...
	return &typeid(T);
	Beagle_StackTraceEndM("const std::type_info* GP::AbsT<T>::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
...
const std::type_info* Beagle::GP::AbsT<T>::getReturnType(Beagle::GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(T);
	Beagle_StackTraceEndM("const std::type_info* GP::AbsT<T>::getReturnType(GP::Context& ioContext) const");
}
...
void Beagle::GP::AbsT<T>::execute(Beagle::GP::Datum& outResult, Beagle::GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::AbsT<T>::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
