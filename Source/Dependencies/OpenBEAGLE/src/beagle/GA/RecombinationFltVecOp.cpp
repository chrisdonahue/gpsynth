...
/*!
 *  \file   beagle/GA/src/RecombinationFltVecOp.cpp
 *  \brief  Source code of class GA::RecombinationFltVecOp.
 ...
 */
Beagle::GA::RecombinationFltVecOp::RecombinationFltVecOp(std::string inRecombPbName,
 ...
 */
Individual::Handle Beagle::GA::RecombinationFltVecOp::recombine(Individual::Bag& inIndivPool,
        Context& ioContext)
{
	...
	return lChildIndiv;
	Beagle_StackTraceEndM("Individual::Handle Beagle::GA::RecombinationFltVecOp::recombine(Individual::Bag& inIndivPool,Context& ioContext)");
}
