...
void FitnessMultiObjMin::copy(const Member& inOriginal, System& ioSystem)
{
	...
	(*this) = lOriginal;
	Beagle_StackTraceEndM("void FitnessMultiObjMin::copy(const Member&,System&)");
}
...
const std::string& FitnessMultiObjMin::getType() const
{
	...
	return lType;
	Beagle_StackTraceEndM("const std::string& FitnessMultiObjMin::getType() const");
}
...
bool FitnessMultiObjMin::isDominated(const Fitness& inRightFitness) const
{
	...
	return lNotEqual;
	Beagle_StackTraceEndM("bool FitnessMultiObjMin::isDominated(const Fitness&) const");
}
...
bool FitnessMultiObjMin::isLess(const Object& inRightObj) const
{
	...
	return false;
	Beagle_StackTraceEndM("bool FitnessMultiObjMin::isLess(const Object&) const");
}
