...
void GP::MutationSwapOp::readWithSystem(PACC::XML::ConstIterator inIter, System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::MutationSwapOp::readWithSystem(PACC::XML::ConstIterator, System&)");
}
...
void GP::MutationSwapOp::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void GP::MutationSwapOp::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const");
}
