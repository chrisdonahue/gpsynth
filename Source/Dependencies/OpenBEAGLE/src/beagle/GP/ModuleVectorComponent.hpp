...
public:
	...
	inline const GP::Tree::Handle& operator[](unsigned int inN) const
	{
		...
		return mModules[inN];
		Beagle_StackTraceEndM("const GP::Tree::Handle& GP::ModuleVectorComponent::operator[](unsigned int inN) const");
	}
	...
	inline GP::Tree::Handle& operator[](unsigned int inN)
	{
		Beagle_StackTraceBeginM();
		return mModules[inN];
		Beagle_StackTraceEndM("GP::Tree::Handle& GP::ModuleVectorComponent::operator[](unsigned int inN)");
	}
	...
	inline void add(GP::Tree::Handle inTree)
	{
		...
		Beagle_StackTraceEndM("void GP::ModuleVectorComponent::add(GP::Tree::Handle inTree)");
	}
	...
	inline bool empty() const
	{
		...
		Beagle_StackTraceEndM("bool GP::ModuleVectorComponent::empty() const");
	}
	...
	inline unsigned int size() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GP::ModuleVectorComponent::size() const");
	}
