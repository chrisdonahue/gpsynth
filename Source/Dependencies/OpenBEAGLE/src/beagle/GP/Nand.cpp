...
const std::type_info* GP::Nand::getArgType(unsigned int inN, GP::Context& ioContext) const
{
	...
	return &typeid(Bool);
	Beagle_StackTraceEndM("const std::type_info* GP::Nand::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
...
const std::type_info* GP::Nand::getReturnType(GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(Bool);
	Beagle_StackTraceEndM("const std::type_info* GP::Nand::getReturnType(GP::Context& ioContext) const");
}
...
void GP::Nand::execute(GP::Datum& outResult, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::Nand::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
