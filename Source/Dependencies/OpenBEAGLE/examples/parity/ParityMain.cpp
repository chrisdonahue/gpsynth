...
int main(int argc, char *argv[])
{
	try {
		...
		lSuperSet->addPrimitive(new GP::ArgumentT<Bool>(GP::Argument::eCaching, GP::Argument::eGenerator, "ARGP"));
		...
		lSystem->setEvaluationOp("ParityEvalOp", new ParityEvalOp::Alloc);
