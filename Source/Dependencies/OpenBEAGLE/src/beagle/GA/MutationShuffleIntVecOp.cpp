...
void GA::MutationShuffleIntVecOp::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::MutationShuffleIntVecOp::registerParams(System&)");
}
...
void GA::MutationShuffleIntVecOp::readWithSystem(PACC::XML::ConstIterator inIter, System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::MutationShuffleIntVecOp::readWithSystem(PACC::XML::ConstIterator,System&)");
}
