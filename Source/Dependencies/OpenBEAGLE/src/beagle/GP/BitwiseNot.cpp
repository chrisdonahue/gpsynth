...
const std::type_info* GP::BitwiseNot::getArgType(unsigned int inN, GP::Context& ioContext) const
{
	...
	return &typeid(Int);
	Beagle_StackTraceEndM("const std::type_info* GP::BitwiseNot::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
...
const std::type_info* GP::BitwiseNot::getReturnType(GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(Int);
	Beagle_StackTraceEndM("const std::type_info* GP::BitwiseNot::getReturnType(GP::Context& ioContext) const");
}
...
void GP::BitwiseNot::execute(GP::Datum& outResult, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::BitwiseNot::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
