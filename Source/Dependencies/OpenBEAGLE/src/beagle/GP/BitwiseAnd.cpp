...
const std::type_info* GP::BitwiseAnd::getArgType(unsigned int inN, GP::Context&) const
{
	...
	return &typeid(Int);
	Beagle_StackTraceEndM("const std::type_info* GP::BitwiseAnd::getArgType(unsigned int inN, GP::Context&) const");
}
...
const std::type_info* GP::BitwiseAnd::getReturnType(GP::Context&) const
{
	Beagle_StackTraceBeginM();
	return &typeid(Int);
	Beagle_StackTraceEndM("const std::type_info* GP::BitwiseAnd::getReturnType(GP::Context&) const");
}
...
void GP::BitwiseAnd::execute(GP::Datum& outResult, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::BitwiseAnd::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
