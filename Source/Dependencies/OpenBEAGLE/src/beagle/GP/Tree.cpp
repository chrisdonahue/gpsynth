...
bool GP::Node::operator==(const GP::Node& inRightNode) const
{
	...
	Beagle_StackTraceEndM("bool GP::Node::operator==(const GP::Node&) const");
}
...
void GP::Tree::copy(const Member& inOriginal, System& ioSystem)
{
	...
	(*this) = lOriginal;
	Beagle_StackTraceEndM("void GP::Tree::copy(const Member&,System&)");
}
...
std::string GP::Tree::deparse() const
{
	...
	return lResult;
	Beagle_StackTraceEndM("std::string GP::Tree::deparse() const");
}
...
unsigned int GP::Tree::deparseSubTree(std::string& outResult, unsigned int inN) const
{
	...
	return lSubTreeSize;
	Beagle_StackTraceEndM("unsigned int GP::Tree::deparseSubTree(std::string&,unsigned int) const");
}
...
unsigned int GP::Tree::fixSubTreeSize(unsigned int inNodeIndex)
{
	...
	Beagle_StackTraceEndM("unsigned int GP::Tree::fixSubTreeSize(unsigned int)");
}
...
GP::PrimitiveSet& GP::Tree::getPrimitiveSet(GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("GP::PrimitiveSet& GP::Tree::getPrimitiveSet(GP::Context&) const");
}
...
const std::type_info* GP::Tree::getRootType(GP::Context& ioContext) const
{
	...
	if(mRootType == NULL) {
		...
		return (*lSuperSet)[mPrimitiveSetIndex]->getRootType();
	}
	return mRootType;
	Beagle_StackTraceEndM("const std::type_info* GP::Tree::getRootType(GP::Context&) const");
}
...
unsigned int GP::Tree::getTreeDepth(unsigned int inNodeIndex) const
{
	...
	return lDepth;
	Beagle_StackTraceEndM("unsigned int GP::Tree::getTreeDepth(unsigned int) const");
}
...
void GP::Tree::interpret(GP::Datum& outResult, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::Tree::interpret(GP::Datum&,GP::Context&)");
}
...
bool GP::Tree::isEqual(const Object& inRightObj) const
{
	...
	Beagle_StackTraceEndM("bool GP::Tree::isEqual(const Object&) const");
}
...
void GP::Tree::readWithContext(PACC::XML::ConstIterator inIter, Beagle::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::Tree::readWithContext(PACC::XML::ConstIterator,Beagle::Context&)");
}
...
void GP::Tree::setContextToNode(unsigned int inNodeIndex, GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("void GP::Tree::setContextToNode(unsigned int,GP::Context&) const");
}
...
bool GP::Tree::validateSubTree(unsigned int inNodeIndex, GP::Context& ioContext) const
{
	...
	return true;
	Beagle_StackTraceEndM("bool GP::Tree::validateSubTree(unsigned int,GP::Context&) const");
}
...
void GP::Tree::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void GP::Tree::writeContent(PACC::XML::Streamer&,bool) const");
}
                                    ...
                                    bool inIndent) const
{
	...
	ioStreamer.closeTag();
	return lSubTreeSize;
	Beagle_StackTraceEndM("unsigned int GP::Tree::writeSubTree(PACC::XML::Streamer&,unsigned int,bool) const");
}
