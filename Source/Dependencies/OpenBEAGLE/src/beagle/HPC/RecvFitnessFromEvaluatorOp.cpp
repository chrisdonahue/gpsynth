...
void HPC::RecvFitnessFromEvaluatorOp::init(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("HPC::RecvFitnessFromEvaluatorOp::init(System&)");
}
...
{
	Beagle_StackTraceBeginM();
	Beagle_StackTraceEndM("Fitness::Handle RecvFitnessFromEvaluatorOp::evaluate(Individual& inIndividual, Context& ioContext)");
}
