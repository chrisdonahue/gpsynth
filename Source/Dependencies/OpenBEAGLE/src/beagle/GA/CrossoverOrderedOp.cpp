...
void Beagle::GA::CrossoverOrderedOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::CrossoverOrderedOp::registerParams(System&)");
}
										  ...
										  Beagle::Context&    ioContext2)
{
	...
	return true;
	Beagle_StackTraceEndM("bool GA::CrossoverOrderedOp::mate(Individual& ioIndiv1, Context& ioContext1, Individual& ioIndiv2, Context& ioContext2)");
}
