...
void HPC::SwitchTypeOp::init(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void HPC::SwitchTypeOp::initialize(System& ioSystem)");
}
...
void HPC::SwitchTypeOp::operate(Deme& ioDeme, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void HPC::SwitchTypeOp::operate(Deme& ioDeme, Context& ioContext)");
}
...
void HPC::SwitchTypeOp::readWithSystem(PACC::XML::ConstIterator inIter, System& ioSystem)
{
	...
	mOperatorSetMap.clear();
        ...
        Beagle_StackTraceEndM("void HPC::SwitchTypeOp::readWithSystem(PACC::XML::ConstIterator, System&)");
}
...
void HPC::SwitchTypeOp::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void HPC::SwitchTypeOp::registerParams(System&)");
}
...
void HPC::SwitchTypeOp::write(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	ioStreamer.closeTag();
	Beagle_StackTraceEndM("void HPC::SwitchTypeOp::write(PACC::XML::Streamer& ioStreamer, bool inIndent) const");
}
