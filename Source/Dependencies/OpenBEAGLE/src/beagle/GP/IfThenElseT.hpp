        ...
        Beagle::GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("const std::type_info* GP::IfThenElseT<ProcessedType,ConditionType>::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
...
Beagle::GP::IfThenElseT<ProcessedType,ConditionType>::getReturnType(Beagle::GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(ProcessedType);
	Beagle_StackTraceEndM("const std::type_info*  GP::IfThenElseT<ProcessedType,ConditionType>::getReturnType(GP::Context& ioContext) const");
}
        ...
        Beagle::GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::IfThenElseT<ProcessedType,ConditionType>::execute(GP::Datum& outResult,  GP::Context& ioContext)");
}
