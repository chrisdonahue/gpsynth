        ...
        GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("GP::Invoker::Handle GP::Module::generateInvoker(unsigned int inIndex, string inName, string inArgsName, GP::Context& ioContext) const");
}
                                       ...
                                       GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("void GP::Module::getCandidatesToInvoke(std::vector<unsigned int>& outCandidates, unsigned int inNumberArguments, GP::Context& ioContext) const");
}
...
bool GP::Module::validate(GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("bool GP::Module::validate(GP::Context& ioContext) const");
}
