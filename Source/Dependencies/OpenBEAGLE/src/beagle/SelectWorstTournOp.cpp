...
/*!
 *  \file   beagle/src/SelectWorstTournOp.cpp
 ...
 */
void SelectWorstTournOp::registerParams(System& ioSystem)
{
 ...
 */
unsigned int SelectWorstTournOp::selectIndividual(Individual::Bag& ioPool, Context& ioContext)
{
	Beagle_StackTraceBeginM();
