...
./build/GeneticProgrammingSynthesizer --target ./build/AMExample.wav --exp 0 --threshold 0 --numgenerations 100 --values 220 1 1 --popsize 50 --mid 6 --md 8 --ctype 0 --rselect 0 --cselect 0 --crosspercent 0.9 --addchance 0.0 --removechance 0.0 --mutatechance 0.05
