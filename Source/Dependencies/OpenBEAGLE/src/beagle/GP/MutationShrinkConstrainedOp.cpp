...
void GP::MutationShrinkConstrainedOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::MutationShrinkConstrainedOp::registerParams(Beagle::System&)");
}
...
bool GP::MutationShrinkConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("bool GP::MutationShrinkConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)");
}
