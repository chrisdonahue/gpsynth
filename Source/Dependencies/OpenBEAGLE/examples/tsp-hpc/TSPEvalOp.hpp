 ...
 *  \ingroup TSP
 */
class TSPEvalOp : public Beagle::HPC::EvaluationOp
{

public:

	//! TSPEvalOp allocator type.
	typedef Beagle::AllocatorT<TSPEvalOp,Beagle::HPC::EvaluationOp::Alloc>
	Alloc;
	//!< TSPEvalOp handle type.
	typedef Beagle::PointerT<TSPEvalOp,Beagle::HPC::EvaluationOp::Handle>
	Handle;
	//!< TSPEvalOp bag type.
	typedef Beagle::ContainerT<TSPEvalOp,Beagle::HPC::EvaluationOp::Bag>
	Bag;
