...
public:
	...
	inline float getNormalizedFitness() const
	{
		...
		return mValue;
		Beagle_StackTraceEndM("float GP::FitnessKoza::getNormalizedFitness() const");
	}
	...
	inline float getAdjustedFitness() const
	{
		...
		Beagle_StackTraceEndM("float GP::FitnessKoza::getAdjustedFitness() const");
	}
	...
	inline float getStandardizedFitness() const
	{
		...
		Beagle_StackTraceEndM("float GP::FitnessKoza::getStandardizedFitness() const");
	}
	...
	inline float getRawFitness() const
	{
		Beagle_StackTraceBeginM();
		return mRawFitness;
		Beagle_StackTraceEndM("float GP::FitnessKoza::getRawFitness() const");
	}
	...
	inline unsigned int getHits() const
	{
		Beagle_StackTraceBeginM();
		return mHits;
		Beagle_StackTraceEndM("unsigned int GP::FitnessKoza::getHits() const");
	}
