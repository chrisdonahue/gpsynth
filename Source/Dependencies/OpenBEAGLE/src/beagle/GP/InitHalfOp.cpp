...
/*!
 *  \file   beagle/GP/src/InitHalfOp.cpp
 *  \brief  Source code of class GP::InitHalfOp.
...
/*!
 *  \brief Construct a GP "half-and-half" initialization operator.
 *  \param inReproProbaName Reproduction probability parameter name used in register. 
 *  \param inName Name of the operator.
 */
GP::InitHalfOp::InitHalfOp(std::string inReproProbaName, std::string inName) :
...
/*!
 *  \brief Register the parameters of the GP "half-and-half" intialization operator.
 *  \param ioSystem System of the evolution.
 */
void GP::InitHalfOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::InitHalfOp::registerParams(Beagle::System&)");
}
                                      ...
                                      GP::Context &ioContext) const
{
	...
	Beagle_StackTraceEndM("unsigned int GP::InitHalfOp::initTree(GP::Tree &outTree, unsigned int inMinDepth, unsigned int inMaxDepth, GP::Context &ioContext) const");
}
