...
void GP::PrimitiveSet::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::PrimitiveSet::registerParams(System&)");
}
...
void GP::PrimitiveSet::insert(GP::Primitive::Handle inPrimitive, double inBias)
{
	...
	Beagle_StackTraceEndM("void GP::PrimitiveSet::insert(GP::Primitive::Handle,double)");
}
        ...
        GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("GP::Primitive::Handle GP::PrimitiveSet::select(unsigned int,GP::Context&)");
}
        ...
        GP::Context& ioContext)
{
	...
	if(lRoulette.empty()) return Primitive::Handle(NULL);
	return (*this)[lRoulette.select(ioContext.getSystem().getRandomizer())];
	Beagle_StackTraceEndM("GP::Primitive::Handle GP::PrimitiveSet::selectWithType(unsigned int,const std::type_info*,GP::Context&)");
}
...
void GP::PrimitiveSet::readWithContext(PACC::XML::ConstIterator inIter, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::PrimitiveSet::readWithContext(PACC::XML::ConstIterator,GP::Context&)");
}
...
void GP::PrimitiveSet::write(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void GP::PrimitiveSet::write(PACC::XML::Streamer&,bool) const");
}
