...
void GP::MutationShrinkOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::MutationShrinkOp::registerParams(Beagle::System&)");
}
...
bool GP::MutationShrinkOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)
{
	...
	return true;
	Beagle_StackTraceEndM("bool GP::MutationShrinkOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)");
}
