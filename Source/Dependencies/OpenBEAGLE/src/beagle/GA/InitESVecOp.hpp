...
public:
	...
	unsigned int getESVectorSize() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GA::InitESVecOp::getESVectorSize() const");
	}
	...
	void setESVectorSize(unsigned int inESVectorSize)
	{
		...
		Beagle_StackTraceEndM("void GA::InitESVecOp::setESVectorSize(unsigned int inESVectorSize)");
	}
