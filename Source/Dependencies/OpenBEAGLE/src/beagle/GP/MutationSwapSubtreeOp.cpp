...
void GP::MutationSwapSubtreeOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::MutationSwapSubtreeOp::registerParams(Beagle::System&)");
}
...
void GP::MutationSwapSubtreeOp::readWithSystem(PACC::XML::ConstIterator inIter, System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::MutationSwapSubtreeOp::readWithSystem(PACC::XML::ConstIterator, System& ioSystem)");
}
