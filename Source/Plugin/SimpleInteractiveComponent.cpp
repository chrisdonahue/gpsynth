...
#include "SimpleInteractiveComponent.h"

//==============================================================================
SimpleInteractiveComponent::SimpleInteractiveComponent (GPNetwork* net, double sr)
    : playsound (0),
      freqslider (0),
      freqlabel (0),
      upvote (0),
      ...
      cycle(0)
{
    ...
    frequency = (double*) malloc(sizeof(double));
...
SimpleInteractiveComponent::~SimpleInteractiveComponent()
{
...
//==============================================================================
void SimpleInteractiveComponent::paint (Graphics& g)
{
...
void SimpleInteractiveComponent::resized()
{
...
void SimpleInteractiveComponent::buttonClicked (Button* buttonThatWasClicked)
{
...
void SimpleInteractiveComponent::sliderValueChanged (Slider* sliderThatWasMoved)
{
...
<JUCER_COMPONENT documentType="Component" className="SimpleInteractiveComponent" componentName=""
