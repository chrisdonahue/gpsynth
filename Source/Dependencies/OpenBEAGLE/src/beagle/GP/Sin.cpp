...
const std::type_info* GP::Sin::getArgType(unsigned int inN, GP::Context& ioContext) const
{
	...
	Beagle_StackTraceEndM("const std::type_info* GP::Sin::getArgType(unsigned int inN, GP::Context& ioContext) const");
}
...
const std::type_info* GP::Sin::getReturnType(GP::Context& ioContext) const
{
	Beagle_StackTraceBeginM();
	return &typeid(Double);
	Beagle_StackTraceEndM("const std::type_info* GP::Sin::getReturnType(GP::Context& ioContext) const");
}
...
void GP::Sin::execute(GP::Datum& outResult, GP::Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void GP::Sin::execute(GP::Datum& outResult, GP::Context& ioContext)");
}
