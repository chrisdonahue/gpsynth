...
public:
	...
	inline unsigned int getNbrOfRelation(const std::string& inRelationType) const {
		...
		Beagle_StackTraceEndM("void getNbrOfRelation(const std::string&)");
	}
	...
	inline unsigned int getNbrOfType(const std::string& inNodeType) const {
		...
		Beagle_StackTraceEndM("void getNbrOfType(const std::string&)");
	}
			 ...
			 unsigned int inIndex=0) const
	{
		...
		Beagle_StackTraceEndM("void send(const std::string&, const std::string&, const std::string&, int) const");
	}
				    ...
				    unsigned int inIndex=0) const
	{
		...
		Beagle_StackTraceEndM("void sendNonBlocking(const std::string&, Request&, const std::string&, const std::string&, int) const");
	}
	                    ...
	                    unsigned int inIndex=0) const
	{
		...
		Beagle_StackTraceEndM("void receive(std::string&, const std::string&, const std::string&, int) const");
	}
				       ...
				       unsigned int inIndex=0) const
	{
		...
		Beagle_StackTraceEndM("void receiveNonBlocking(Request&, const std::string&, const std::string&, int) const");
	}
	...
	*/
	inline bool isMultipleThreadsProvided() const
	{
		...
		Beagle_StackTraceEndM("bool HPC::MPICommunication::isMultipleThreadsProvided()");
	}
	...
	*/
	inline std::string getNodeType() const
	{
		Beagle_StackTraceBeginM();
		return mNodeType;
		Beagle_StackTraceEndM("std::::string HPC::MPICommunication::getNodeType()");
	}
	...
	inline const UInt::Handle getNodeRank() const
	{
		Beagle_StackTraceBeginM();
		return mNodeRank;
		Beagle_StackTraceEndM("const UInt::Handle HPC::MPICommunication::getNodeRank()");
	}
