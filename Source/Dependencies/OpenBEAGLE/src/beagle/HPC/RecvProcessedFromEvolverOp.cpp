...
Fitness::Handle HPC::RecvProcessedFromEvolverOp::evaluate(Individual& inIndividual, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("Fitness::Handle HPC::RecvProcessedFromEvolverOp::evaluate(Beagle::Individual& inIndividual, Beagle::Context& ioContext)");
}
...
void HPC::RecvProcessedFromEvolverOp::init(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("HPC::RecvProcessedFromEvolverOp::init(System&)");
}
...
void HPC::RecvProcessedFromEvolverOp::operate(Deme& ioDeme, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void HPC::RecvProcessedFromEvolverOp::operate(Deme&, Context&)");
}
