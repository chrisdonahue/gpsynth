...
public:
	...
	inline const std::vector<unsigned int>& getCallStack() const
	{
		Beagle_StackTraceBeginM();
		return mCallStack;
		Beagle_StackTraceEndM("const std::vector<unsigned int>& GP::Context::getCallStack() const");
	}
	...
	inline std::vector<unsigned int>& getCallStack()
	{
		Beagle_StackTraceBeginM();
		return mCallStack;
		Beagle_StackTraceEndM("std::vector<unsigned int>& GP::Context::getCallStack()");
	}
