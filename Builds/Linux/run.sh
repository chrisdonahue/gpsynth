...
./build/GeneticProgrammingSynthesizer --target ./samples/TrumpetEb5.wav --seed 0 --verbose --values 622.25 --fft 1024 --fitnesstype 1 --experiment 5 --generations 4 --erc --popsize 20 --mid 1 -- md 3 --numericmutation 0.5 --nmselect 1 --nmselectparam 0.05 --nmtemperature 0.9 --crossover 0.9 --cselect 0 --ctype 0 --reproduction 0.05 --rselect 0
