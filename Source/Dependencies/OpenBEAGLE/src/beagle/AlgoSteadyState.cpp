...
/*!
 *  \file   beagle/src/AlgoSteadyState.cpp
 *  \brief  Source code of class AlgoSteadyState.
...
/*!
 *  \brief Construct steady-state evolutionary algorithm.
 */
AlgoSteadyState::AlgoSteadyState(void) :
		Algorithm("AlgoSteadyState")
{ }
