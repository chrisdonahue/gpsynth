...
void FitnessMultiObj::copy(const Member& inOriginal, System& ioSystem)
{
	...
	(*this) = lOriginal;
	Beagle_StackTraceEndM("void FitnessMultiObj::copy(const Member&,System&)");
}
...
double FitnessMultiObj::getDistance(const Fitness& inRightFitness) const
{
	...
	Beagle_StackTraceEndM("double FitnessMultiObj::getDistance(const Fitness&) const");
}
...
unsigned int FitnessMultiObj::getNumberOfObjectives() const
{
	...
	return size();
	Beagle_StackTraceEndM("unsigned int FitnessMultiObj::getNumberOfObjectives() const");
}
...
bool FitnessMultiObj::isDominated(const Fitness& inRightFitness) const
{
	...
	return lNotEqual;
	Beagle_StackTraceEndM("bool FitnessMultiObj::isDominated(const FitnessMultiObj&) const");
}
...
bool FitnessMultiObj::isEqual(const Object& inRightObj) const
{
	...
	return true;
	Beagle_StackTraceEndM("bool FitnessMultiObj::isEqual(const Object&) const");
}
...
bool FitnessMultiObj::isLess(const Object& inRightObj) const
{
	...
	return false;
	Beagle_StackTraceEndM("bool FitnessMultiObj::isLess(const Object&) const");
}
...
void FitnessMultiObj::read(PACC::XML::ConstIterator inIter)
{
	...
	Beagle_StackTraceEndM("void FitnessMultiObj::read(PACC::XML::ConstIterator)");
}
...
void FitnessMultiObj::writeContent(PACC::XML::Streamer& ioStreamer, bool inIndent) const
{
	...
	Beagle_StackTraceEndM("void FitnessMultiObj::write(PACC::XML::Streamer&,bool) const");
}
