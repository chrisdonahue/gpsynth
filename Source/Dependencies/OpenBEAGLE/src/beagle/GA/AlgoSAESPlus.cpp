...
/*!
 *  \file   beagle/GA/src/AlgoSAESPlus.cpp
 *  \brief  Source code of class GA::AlgoSAESPlus.
 ...
 */
GA::AlgoSAESPlus::AlgoSAESPlus(void) :
		Algorithm("GA-AlgoSAESPlus")
{ }
 ...
 *
 */
void GA::AlgoSAESPlus::configure(Evolver& ioEvolver, System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void AlgoSAESPlus::configure(Evolver&,System&)");
}
