...
void Beagle::GA::CrossoverCycleOp::registerParams(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::CrossoverCycleOp::registerParams(System&)");
}
									   ...
									   Beagle::Context&    ioContext2)
{
	...
	return true;
	Beagle_StackTraceEndM("bool GA::CrossoverCycleOp::mate(Individual& ioIndiv1, Context& ioContext1, Individual& ioIndiv2, Context& ioContext2)");
}
