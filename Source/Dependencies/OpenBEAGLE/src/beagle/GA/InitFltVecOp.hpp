...
public:
	...
	unsigned int getFloatVectorSize() const
	{
		...
		Beagle_StackTraceEndM("unsigned int GA::InitFltVecOp::getFloatVectorSize() const");
	}
	...
	void setFloatVectorSize(unsigned int inFloatVectorSize)
	{
		...
		Beagle_StackTraceEndM("void GA::InitFltVecOp::getFloatVectorSize(unsigned int inFloatVectorSize)");
	}
