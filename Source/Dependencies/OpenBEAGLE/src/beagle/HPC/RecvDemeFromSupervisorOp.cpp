...
void HPC::RecvDemeFromSupervisorOp::init(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("HPC::RecvDemeFromSupervisorOp::init(System&)");
}
...
void HPC::RecvDemeFromSupervisorOp::operate(Deme& ioDeme, Context& ioContext)
{
	...
	Beagle_StackTraceEndM("void HPC::RecvDemeFromSupervisorOp::operate(Deme& ioDeme, Context& ioContext)");  
}
