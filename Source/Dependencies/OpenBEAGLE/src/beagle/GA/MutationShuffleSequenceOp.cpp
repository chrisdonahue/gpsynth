...
void GA::MutationShuffleSequenceOp::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GA::MutationShuffleSequenceOp::registerParams(System&)");
}
...
bool GA::MutationShuffleSequenceOp::mutate(Beagle::Individual& ioIndividual, Context& ioContext)
{
	...
	return lMutated;
	Beagle_StackTraceEndM("bool GA::MutationShuffleSequenceOp::mutate(Beagle::Individual& ioIndividual, Context& ioContext)");
}
