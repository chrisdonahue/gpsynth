	...
	mStreamerFileTemp(mFileStreamTemp)
{
	...
	Beagle_StackTraceEndM("LoggerXMLD::LoggerXMLD(const LoggerXMLD&)");
}
...
//			mThread->cancel();
	...
	Beagle_StackTraceEndM("LoggerXMLD::~LoggerXMLD(void)");
}
...
void HPC::LoggerXMLD::operator=(const LoggerXMLD&)
{
	...
	Beagle_StackTraceEndM("void LoggerXMLD::operator=(const LoggerXMLD&)");
}
...
void HPC::LoggerXMLD::init(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void LoggerXMLD::init(System&)");
}
				    ...
				    const std::string& inClass)
{
	...
	mStreamMutex.unlock();
	Beagle_StackTraceEndM("void LoggerXMLD::outputMessage(cons std::string&, unsigned int, const std::string&, const std::string&)");
}
				   ...
				   const std::string& inClass)
{
	...
	mStreamMutex.unlock();
	Beagle_StackTraceEndM("void LoggerXMLD::outputObject(const Object&, unsigned int, const std::string&, const std::string& inClass)");
}
...
void HPC::LoggerXMLD::terminate(void)
{
	...
	mStreamMutex.unlock();
	Beagle_StackTraceEndM("void HPC::LoggerXMLD::terminate(void)");
}
...
void HPC::LoggerXMLD::registerParams(System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void HPC::LoggerXMLD::registerParams(System&)");
}
