        ...
        Beagle::GP::Context& ioContext)
{
	...
	lActualTree[lNodeIndex].mPrimitive->execute(outResult, ioContext);
	ioContext.popCallStack();
	Beagle_StackTraceEndM("void GP::Primitive::get2ndArgument(GP::Datum& outResult, GP::Context& ioContext)");
}
        ...
        Beagle::GP::Context& ioContext)
{
	...
	lActualTree[lNodeIndex].mPrimitive->execute(outResult, ioContext);
	ioContext.popCallStack();
	Beagle_StackTraceEndM("void GP::Primitive::get3rdArgument(GP::Datum& outResult, GP::Context& ioContext)");
}
...
inline unsigned int Beagle::GP::Primitive::getNumberArguments() const
{
	...
	Beagle_StackTraceEndM("unsigned int GP::Primitive::getNumberArguments() const");
}
...
inline void Beagle::GP::Primitive::setNumberArguments(unsigned int inNumberArguments)
{
	...
	Beagle_StackTraceEndM("void GP::Primitive::setNumberArguments(unsigned int inNumberArguments)");
}
