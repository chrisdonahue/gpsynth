...
public:
	...
	inline GP::Primitive::Handle getPrimitiveByName(std::string inName) const
	{
		...
		return lPrimitive;
		Beagle_StackTraceEndM("GP::Primitive::Handle GP::PrimitiveSet::getPrimitiveByName(std::string inName) const");
	}
	...
	inline void setRootType(const std::type_info* inRootType)
	{
		...
		Beagle_StackTraceEndM("void GP::PrimitiveSet::setRootType(const std::type_info* inRootType)");
	}
#endif // BEAGLE_HAVE_RTTI
